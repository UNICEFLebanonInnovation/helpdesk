...
demo:
	...
	helpdesk createsuperuser --username admin --email helpdesk@example.com
	# Install fixtures
	helpdesk loaddata emailtemplate.json
	helpdesk loaddata demo.json
